...
TEST(Transform_t, ctor_ref){
    ...
    transform_t<int,int,std::vector<int>,detail::Reference_storage>  x(func, detail::chaineable_store_t<std::vector<int>, detail::Reference_storage>(vec));
...
TEST(Transform_t, ctor_val){
    ...
    transform_t<int,int,std::vector<int>,detail::Value_storage>  x(func, detail::chaineable_store_t<std::vector<int>, detail::Value_storage>(std::move(vec)));
...
TEST(Transform_t, chain_ref){
    ...
    transform_t<int,int,std::vector<int>,detail::Reference_storage>  x(func1, detail::chaineable_store_t<std::vector<int>, detail::Reference_storage>(vec));
...
TEST(Transform_t, chain_val){
    ...
    transform_t<int,int, inside_t, detail::Value_storage>  x(func2, inside_t(func1, detail::chaineable_store_t<std::vector<int>, detail::Value_storage>(std::vector<int>{{2,2,1,1}})));
